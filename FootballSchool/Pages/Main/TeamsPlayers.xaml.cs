...
namespace FootballSchool.Pages.Main
{
	...
	public partial class TeamsPlayers
	{
		...
		private void MenuRemovePlayer_OnClick(object sender, RoutedEventArgs e)
		{
			...
			_entities.Players.DeleteObject(_entities.Players.FirstOrDefault(x => x.Id == selectedPlayer.Id));
			SaveAndRefresh();
		}
		...
		private void MenuRemoveGameEvent_OnClick(object sender, RoutedEventArgs e)
		{
			...
			_entities.GameEvents.DeleteObject(_entities.GameEvents.FirstOrDefault(x => x.Id == selectedGameEvent.Id));
			SaveAndRefresh();
		}
		...
		private void MenuRemoveTeam_OnClick(object sender, RoutedEventArgs e)
		{
			...
			_entities.Teams.DeleteObject(_entities.Teams.FirstOrDefault(x => x.Id == selectedTeam.Id));
			SaveAndRefresh();
		}
