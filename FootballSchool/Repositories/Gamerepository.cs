...
namespace FootballSchool.Repositories
{
	...
	/// repo for games
	/// </summary>
	public class GameRepository : RepositoryT<Games>
	{
		...
		/// <returns></returns>
		public List<Games> GetGamesForTeam(int teamId)
		{
			return GetAll().Where(game => game.Team1ID == teamId || game.Team2ID == teamId).ToList();
		}
